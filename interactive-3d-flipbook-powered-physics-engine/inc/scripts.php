<?php
  ...
  function register_scripts() {
    ...
    wp_register_script(POST_ID.'-edit', ASSETS_JS.'edit.min.js', array(POST_ID.'-react', POST_ID.'-react-dom', 'jquery', POST_ID.'-pdf-js', POST_ID.'-html2canvas', POST_ID.'-colorpicker'), VERSION, true);
    wp_register_script(POST_ID.'-insert', ASSETS_JS.'insert.min.js', array(POST_ID.'-react', POST_ID.'-react-dom', 'jquery'), VERSION, true);
    wp_register_script(POST_ID.'-settings', ASSETS_JS.'settings.min.js', array(POST_ID.'-react', POST_ID.'-react-dom', 'jquery'), VERSION, true);
    wp_register_script(POST_ID.'-shortcode-generator', ASSETS_JS.'shortcode-generator.js', array(POST_ID.'-react', POST_ID.'-react-dom', 'jquery', POST_ID.'-insert'), VERSION, true);
